...
def login():
    ...
    if request.method == 'POST':
        ...
        # elif username == None :
        #     message = 'Please enter corect username'
        else:
            message = 'Please enter correct email / password !'
...
def transaksi():
    ...
    # if jenis_laundry == 'EXPRESS':
    #     harga = int(berat) * 8000
    # elif jenis_laundry == 'KILAT':
    ...
    cur.execute('INSERT INTO transaksi (id_nota,id_pelanggan,jenis_laundry,berat,tanggal_masuk,id_karyawan,status_pembayaran,status) values (%s,%s,%s,%s,%s,%s,%s,%s)', (new_nota,id_pelanggan,jenis_laundry,berat,tanggal_masuk,nama_karyawan,status_pembayaran,status_pesanan))
    db.commit()
